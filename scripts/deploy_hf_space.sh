...
cp "$PROJECT_ROOT/baseline.py" "$WORKDIR/baseline.py"
cp "$PROJECT_ROOT/pyproject.toml" "$WORKDIR/pyproject.toml"
cp "$PROJECT_ROOT/uv.lock" "$WORKDIR/uv.lock"
cp "$PROJECT_ROOT/server/app.py" "$WORKDIR/server/app.py"
